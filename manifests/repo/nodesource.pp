...
class nodejs::repo::nodesource {
  ...
  case $::osfamily {
    'RedHat': {
      ...
      $baseurl = "https://rpm.nodesource.com/${url_suffix}/${dist_type}/${dist_version}/\$basearch"

      # nodesource-source repo
      $source_descr   = "Node.js for ${name_string} - \$basearch - Source"
      $source_baseurl = "https://rpm.nodesource.com/${url_suffix}/${dist_type}/${dist_version}/SRPMS"
